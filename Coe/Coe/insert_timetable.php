    ...
    <div class="body_of_login_page">
        <div class="simple_form_box">
            ...
            <div class="nav_bar_back">
                <h1>
                    <i style="cursor: pointer;" class='bx bx-arrow-back' height="10%" width="10%"></i>
                </h1>
            </div>
            ...
            <div class="timetable" style="margin-top: 40px;">
                ...
                <div class="commen_class_tt">
                    ...
                    <input type="text" name="sem" placeholder="SELECT SEMISTER" class="box_size">
                </div>
                <div style="width: 100%; border: 1px solid black;"></div>
                <div class="commen_class_tt">
                    <p class="text_tt" style="margin-top: 10px; margin-left: 20px; font-size: 23px;">Course Code</p>
                    <input type="text" name="code" placeholder="SELECT COURSE CODE" class="box_size">
                </div>
...
<div style="width: 100%; border: 1px solid black;"></div>
            ...
            <div class="submit_botton_end" style="width: 100%; display: flex; justify-content: center; ">
                ...
                <input type="submit" name="submit" style="width: 200px; cursor: pointer; height: 50px; background-color: #7ff0f0; border: none; border-radius: 20px; font-size: 19px; font-weight: lighter;" value="Submit">
