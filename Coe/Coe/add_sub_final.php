                ...
                <div class="div-box">
                    <form class="user" method="post" action="Backend/add_sub_bk.php" >
                        ...
                        <datalist id="sem_options">
                            <option value="ODD 23"></option>
                            <option value="EVEN 23"></option>
                            <option value="ODD 24"></option>
                            <option value="EVEN 24"></option>
                            <option value="ODD 25"></option>
                            <option value="EVEN 25"></option>
                        </datalist>
