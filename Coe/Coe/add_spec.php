...
<!-- -----------------------         Q1 --------------------------Q!          Q1---------------------- -->
                ...
                <div class="new_element">
                    ...
                    <div class="commen_class level-que">
                        <p class="unit_box">Leval</p>
                        <input type="text" name="level1" placeholder="Leval" class="class_input" list="list_level">
                    </div>
                    <div class="commen_class marks_que">
                        <p class="unit_box">Marks</p>
                ...
                <div class="new_element">
                    ...
                    <div class="commen_class level-que">
                        <p class="unit_box">Leval</p>
                        <input type="text" name="level2" placeholder="Leval" class="class_input" list="list_level">
                    </div>
                    <div class="commen_class marks_que">
                        <p class="unit_box">Marks</p>
                ...
                <div class="new_element">
                    ...
                    <div class="commen_class level-que">
                        <p class="unit_box">Leval</p>
                        <input type="text" name="level3" placeholder="Leval" class="class_input" list="list_level">
                    </div>
                    <div class="commen_class marks_que">
                        <p class="unit_box">Marks</p>
                ...
                <div class="new_element">
                    ...
                    <div class="commen_class level-que">
                        <p class="unit_box">Leval</p>
                        <input type="text" name="level4" placeholder="Leval" class="class_input" list="list_level">
                    </div>
                    <div class="commen_class marks_que">
                        <p class="unit_box">Marks</p>
                ...
                <div class="new_element">
                    ...
                    <div class="commen_class level-que">
                        <p class="unit_box">Leval</p>
                        <input type="text" name="level5" placeholder="Leval" class="class_input" list="list_level">
                    </div>
                    <div class="commen_class marks_que">
                        <p class="unit_box">Marks</p>
                ...
                <div class="new_element">
                    ...
                    <div class="commen_class level-que">
                        <p class="unit_box">Leval</p>
                        <input type="text" name="level6" placeholder="Leval" class="class_input" list="list_level">
                    </div>
                    <div class="commen_class marks_que">
                        <p class="unit_box">Marks</p>
                ...
                <div class="new_element">
                    ...
                    <div class="commen_class level-que">
                        <p class="unit_box">Leval</p>
                        <input type="text" name="level7" placeholder="Leval" class="class_input" list="list_level">
                    </div>
                    <div class="commen_class marks_que">
                        <p class="unit_box">Marks</p>
...
<!-- H -->
                ...
                <div class="new_element">
                    ...
                    <div class="commen_class level-que">
                        <p class="unit_box">Leval</p>
                        <input type="text" name="level8" placeholder="Leval" class="class_input" list="list_level">
                    </div>
                    <div class="commen_class marks_que">
                        <p class="unit_box">Marks</p>
...
<!-- I -->
                ...
                <div class="new_element">
                    ...
                    <div class="commen_class level-que">
                        <p class="unit_box">Leval</p>
                        <input type="text" name="level9" placeholder="Leval" class="class_input" list="list_level">
                    </div>
                    <div class="commen_class marks_que">
                        <p class="unit_box">Marks</p>
...
<!-- a -->
              ...
              <div class="new_element">
                ...
                <div class="commen_class level-que">
                    ...
                    <input type="text" name="level10" placeholder="Leval" class="class_input" list="list_level">
                </div>
                <div class="commen_class marks_que">
                    <p class="unit_box">Marks</p>
            ...
            <!-- b -->
              ...
              <div class="new_element">
                ...
                <div class="commen_class level-que">
                    <p class="unit_box">Level</p>
                    <input type="text" name="level11" placeholder="Leval" class="class_input" list="list_level">
                </div>
                <div class="commen_class marks_que">
                    <p class="unit_box">Marks</p>
...
<!-- d -->
              ...
              <div class="new_element">
                ...
                <div class="commen_class level-que">
                    <p class="unit_box">Level</p>
                    <input type="text" name="level13" placeholder="Leval" class="class_input" list="list_level">
                </div>
                <div class="commen_class marks_que">
                    <p class="unit_box">Marks</p>
...
<!-- e -->
              ...
              <div class="new_element">
                ...
                <div class="commen_class level-que">
                    <p class="unit_box">Level</p>
                    <input type="text" name="level14" placeholder="Leval" class="class_input" list="list_level">
                </div>
                <div class="commen_class marks_que">
                    <p class="unit_box">Marks</p>
...
<!-- a -->
          ...
          <div class="new_element">
            ...
            <div class="commen_class level-que">
                <p class="unit_box">Level</p>
                <input type="text" name="level15" placeholder="Leval" class="class_input" list="list_level">
            </div>
            <div class="commen_class marks_que">
                <p class="unit_box">Marks</p>
      ...
      <!-- b      -->
          ...
          <div class="new_element">
            ...
            <div class="commen_class level-que">
                <p class="unit_box">Level</p>
                <input type="text" name="level16" placeholder="Leval" class="class_input" list="list_level">
            </div>
            <div class="commen_class marks_que">
                <p class="unit_box">Marks</p>
...
<!-- c -->
          ...
          <div class="new_element">
            ...
            <div class="commen_class level-que">
                <p class="unit_box">Level</p>
                <input type="text" name="level17" placeholder="Leval" class="class_input" list="list_level">
            </div>
            <div class="commen_class marks_que">
                <p class="unit_box">Marks</p>
...
<!-- d -->
          ...
          <div class="new_element">
            ...
            <div class="commen_class level-que">
                <p class="unit_box">Level</p>
                <input type="text" name="level18" placeholder="Leval" class="class_input" list="list_level">
            </div>
            <div class="commen_class marks_que">
                <p class="unit_box">Marks</p>
...
<!-- e -->
          ...
          <div class="new_element">
            ...
            <div class="commen_class level-que">
                <p class="unit_box">Level</p>
                <input type="text" name="level19" placeholder="Leval" class="class_input" list="list_level">
            </div>
            <div class="commen_class marks_que">
                <p class="unit_box">Marks</p>
...
<!-- Q4      ----------------------------------------------------            Q4 -->
  ...
  <div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level20" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level21" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level22" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level23" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level24" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<!-- Q5     --------------------------------------------                Q5 -->
  ...
  <div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level25" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level26" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level27" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level28" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<div class="new_element">
    ...
    <div class="commen_class level-que">
        <p class="unit_box">Leval</p>
        <input type="text" name="level29" placeholder="Leval" class="class_input" list="list_level">
    </div>
    <div class="commen_class marks_que">
        <p class="unit_box">Marks</p>
...
<div class="commen_class level-que">
    <p class="unit_box">Leval</p>
    <input type="text" name="level30" placeholder="Leval" class="class_input" list="list_level">
</div>
<div class="commen_class marks_que">
    <p class="unit_box">Marks</p>
...
<div class="commen_class level-que">
    <p class="unit_box">Leval</p>
    <input type="text" name="level31" placeholder="Leval" class="class_input" list="list_level">
</div>
<div class="commen_class marks_que">
    <p class="unit_box">Marks</p>
...
<div class="commen_class level-que">
    <p class="unit_box">Leval</p>
    <input type="text" name="level32" placeholder="Leval" class="class_input" list="list_level">
</div>
<div class="commen_class marks_que">
    <p class="unit_box">Marks</p>
