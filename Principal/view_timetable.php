    ...
    <div class="body_of_login_page">
        <div class="simple_form_box">
            ...
            <div class="box_button">
                ...
                <div class="button_commen " id="two_t">
                    <button class="one" onclick="cric()">View Titties</button>
                </div>
        ...
        <div class="main-div">
            ...
            <div class="div-2" style="flex-direction: column;">
                <div class="heading" >
                    <h1 style="font-size: 35px; font-weight: lighter; font-family: Arial, Helvetica, sans-serif; text-decoration: underline;">Principal</h1>
